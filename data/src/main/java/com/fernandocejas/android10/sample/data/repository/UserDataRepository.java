...
public class UserDataRepository implements UserRepository {
    ...
    public Observable<List<User>> getUsers() {
        ...
        return userDataStore.getUserEntityList().map(userEntities -> this.userEntityDataMapper.transform(userEntities));
    }
    ...
    public Observable<User> getUser(int userId) {
        ...
        return userDataStore.getUserEntityDetails(userId).map(userEntity -> this.userEntityDataMapper.transform(userEntity));
    }
}
