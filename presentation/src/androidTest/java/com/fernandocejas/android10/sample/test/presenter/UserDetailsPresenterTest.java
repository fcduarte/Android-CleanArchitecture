...
public class UserDetailsPresenterTest extends AndroidTestCase {
    ...
    @Mock private GetUserDetailsUseCase mockGetUserDetailsUseCase;
    ...
    protected void setUp() throws Exception {
        ...
        userDetailsPresenter = new UserDetailsPresenter(mockGetUserDetailsUseCase, mockUserModelDataMapper);
